...
if (user_login_check($mysqli) == true or user_cookie_login_check($mysqli) == true) {
    ...
    if ($message_sent == true){
        header("Location: login/members/contact.php?MessageSent=true");

    }else if ($user_blocked == true){
        header("Location: login/members/contact.php?UserBlocked=true");

    }
    else {
        header("Location: login/members/contact.php");
...
<div role="main" class="container">
 ...
 <div class="container contact-form">
                    <form accept-charset="UTF-8" class="needs-validation" method="post" action="login/includes/add_message.php" novalidate>
                        <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="Name" class="form-control" placeholder="إسمك كاملا" value="" required/>
                                        <div class="invalid-feedback">
                                        الرجاء إدخال  إسمك.
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="Email" class="form-control" placeholder="بريدك الإلكتروني" value="" required/>
                                        <div class="invalid-feedback">
