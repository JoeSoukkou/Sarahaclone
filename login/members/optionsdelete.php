    ...
    <div class="row" >
      <div class="col-lg-12">
        <div class="py-5 text-center">
          ...
          <p class="lead">يمكنك حذف حسابك أسفله .</a></p>
        </div>
      </div> 
    </div>
    <div class="row">
      <div class="col-md-4 order-md-1">
        ...
        <a href="#" class="list-group-item list-group-item-action active">حذف الحساب  <i class="fas fa-user-minus"></i></a>
        <a href="optionsprivate.php" class="list-group-item list-group-item-action">الخصوصية <i class="fas fa-user-secret"></i></a>
        </div>
      </div>
      <div class="col-md-8 ">
      <div class="alert alert-danger" role="alert">
          ملاحظة : حذف الحساب نهائي وغير قابل للتراجع
      </div>
                    <!-- Button trigger modal -->
          <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModalCenter">
            حذف الحساب <i class="fas fa-user-minus"></i>
          </button>

          <!-- Modal -->
          <div dir="ltr" class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalCenterTitle">تأكيد حذف الحساب </h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body">
                  .هل تود حقا حذف حسابك نهائيا ؟ هذه العملية غير قابلة للعكس 
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">تراجع <i class="fas fa-undo-alt"></i></button>
                    <form method="post" action="../includes/deleteaccount.php">
                      <button type="submit" name='deletemyaccount' value="yesdeletemyaccount" class="btn btn-danger">حذف حسابي <i class="fas fa-user-minus"></i></button>
                    </form>
                </div>
              </div>
            </div>
