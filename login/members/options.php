...
<div role="main" class="container" style="padding-top: 12rem;">
    <div class="row">
      <div class="col-lg-12">
        <div class="py-5 text-center">
          <h2>تعديل الحساب <i class="fas fa-user-edit"></i></h2>
          <p class="lead">يمكنك تغيير معلومات حسابك أسفله وتحديثها .</a></p>
        </div>
      </div> 
    </div>
    <div class="row">
    ...
    <div class="list-group">
      ...
      <a href="#" class="list-group-item list-group-item-action active">الملف الشخصي <i class="fas fa-user-circle"></i></a>
      ...
      <form method="post" action="../includes/updateaccount.php" accept-charset="UTF-8" class="needs-validation" novalidate>
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="text" name="firstname" class="form-control" id="firstName" placeholder="إسمك" value="<?php echo $_COOKIE['Xstname']; ?>" required>
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" name="secondname" class="form-control" id="lastName" placeholder="إسم العائلة" value="<?php echo $_COOKIE['Xndname']; ?>" required>
            <div class="invalid-feedback">
                الإسم الثاني مطلوب .
            </div>
          </div>
        ...
        <div class="mb-3">
          <label for="username" style="float:right;">إسم المستخدم</label>
            <input type="text" name="username" class="form-control" id="username" placeholder="" value="<?php echo $_COOKIE['Xuser']; ?>" required>
        ...
        <div class="mb-3">
          ...
          <input type="email" name="email" class="form-control" id="email" placeholder="" value="<?php echo $_COOKIE['Xemail']; ?>" required>
          <div class="invalid-feedback">
