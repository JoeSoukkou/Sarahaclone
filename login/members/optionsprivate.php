...
<div role="main" class="container" style="padding-top: 3rem;">
    <div class="row">
      <div class="col-lg-12">
        <div class="py-5 text-center">
          <h2>تعديل الحساب <i class="fas fa-user-edit"></i></h2>
          <p class="lead">يمكنك تغيير معلومات الخصوصية لحسابك أسفله  .</a></p>
        </div>
      </div> 
    </div>
    <div class="row">
    ...
    <div class="list-group">
      ...
      <a href="optionspass.php" class="list-group-item list-group-item-action">الرقم السري <i class="fas fa-key"></i></a>
      <a href="optionsdelete.php" class="list-group-item list-group-item-action">حذف الحساب  <i class="fas fa-user-minus"></i></a>
      <a href="#" class="list-group-item list-group-item-action active">الخصوصية <i class="fas fa-user-secret"></i></a>
    </div>
    ...
    <div class="col-md-8 ">
      <form method="post" action="../includes/updateaccount.php" accept-charset="UTF-8" class="needs-validation" novalidate>
          <div class="form-group">
            <label for="exampleFormControlSelect1" style="float:right;">إستقبال المصارحات من :</label>
            <select class="form-control" id="exampleFormControlSelect1">
            <option>أي شخص</option>
          ...
          <div class="form-group" style="float:right;">
              ...
              <label class="custom-control-label" for="customControlAutosizing1"> الظهور في البحث</label>
              </div>
          </div>
          <div class="form-group" style="float:right;">
              <div class="custom-control custom-checkbox mr-sm-2">
              <input type="checkbox" class="custom-control-input" id="customControlAutosizing2">
              <label class="custom-control-label" for="customControlAutosizing2"> الإشعارات</label>
              </div>
          </div>
          ...
          <div class="form-group" style="float:right;">
              ...
              <label class="custom-control-label" for="customControlAutosizing3">إظهار هويتي عند إرسال رسالة</label>
              </div>
          </div>        
        <button name="upd_privacy" class="btn btn-primary btn-lg btn-block" type="submit"> حفظ  <i class="fas fa-user-edit"></i></button>
    </form>
    </div>
