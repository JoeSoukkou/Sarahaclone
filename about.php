...
if (user_login_check($mysqli) == true or user_cookie_login_check($mysqli) == true) {
    $user_logged = 'in';
    header("Location: login/members/about.php");
} else {
    $user_logged = 'out';
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            ...
            <form class="form-inline my-2 my-lg-0" >
                    <div class="input-group">
                        <input class="form-control" type="text" style="border-radius:0;background-color: #212529;border-color: #212529;color:#909192;" placeholder="إبحث في الموقع ">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="#">عن الموقع <i class="fab fa-connectdevelop"></i></a>
            </li>
            <li class="nav-item">
