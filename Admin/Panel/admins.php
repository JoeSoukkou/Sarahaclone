        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">قائمة المشرفين بالموقع</h4>
                                <p class="category">يمكنك حذف أو إضافة المشرفين</p>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        <?php 
                                            $query = "SELECT id, first_admin_name, second_admin_name, email
                                            FROM admins
                                                        ";
                                            ...
                                            while ($row = mysqli_fetch_array($response)){
                                                ...
                                                <tr>
                                                    <td>'.$row['id'].'</td>
                                                    <td>'.$row['first_admin_name'].' '.$row['second_admin_name'].'</td>
                                                    <td>'.$row['email'].'</td>
                                                    <td>
                                                    <form method="post" action="../includes/deleteadmin.php">
                                                        <button name="delete" value="'.$row['email'].'" type="submit" class="btn btn-sm btn-danger">حذف</button>
                                                    </form>
                                                    </td>
                                                </tr>';
                                        ...
                                        <tr>
                                            <td></td>
                                        	<td><a href="addadmin.php"><button class='btn btn-block btn-primary'>إضافة مشرف جديد +</button></a></td>
                                            <td></td>
                                        </tr>
                                    </tbody>
                                </table>
