...
/* php code goes under this section of the program */
    ...
    // Change the msgs read status 
    $markread = $mysqli->prepare("UPDATE `dash_messages` SET `is_read`=1");
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">الرسائل الواردة</h4>
                                <p class="category">يمكنك حذف الرسائل  </p>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    <thead>
                                        <tr><th>الرقم</th>
                                    	<th>إسم المرسل كاملا</th>
                                    	<th> البريد الإلكتروني للمرسل</th>
                                    	<th> رقم الهاتف</th>
                                    	<th> الرسالة</th>
                                    ...
                                    <tbody>
                                    <?php 
                                        $stmt = "SELECT id, sender_name, sender_email, sender_phone, sender_content
                                        FROM dash_messages
                                                    ";
                                        ...
                                        while ($row = mysqli_fetch_array($response)){
                                            ...
                                            <tr>
                                                ...
                                                <td>'.$row['sender_content'].'</td>
                                                <form method="post" action="../includes/deleteusermessage.php">
                                                                                                
                                                <td><button name="deleteusermessage" type="submit" value="'.$row['id'].'" class="btn btn-sm btn-danger">حذف الرسالة</button></td>
                                                </form>
                                            </tr>';
