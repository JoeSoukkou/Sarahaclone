        ...
        <div class="content">
            ...
            <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">تعديل معلومات الحساب</h4>
                            </div>
                            <div class="content">
                            <form method="post" action="../includes/updateaccount.php">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label> البريد الإلكتروني </label>
                                                <input type="text" name="email" class="form-control"  placeholder="البريد الإلكتروني " value="<?php echo $_COOKIE['Aemail'];?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label> الإسم الأخير</label>
                                                <input name="secondname" type="text" class="form-control" placeholder="الإسم العائلي" value="<?php echo $_COOKIE['Andname'];?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"> الإسم الأول </label>
                                                <input name="firstname" type="text" class="form-control" placeholder="إسم المشرف" value="<?php echo $_COOKIE['Astname'];?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="username" class="form-control" placeholder="إسم المستخدم" value="<?php echo $_COOKIE['Auser'];?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <button type="submit" class="btn btn-info btn-fill pull-right">  حفظ التعديلات +</button>
                            ...
                            <div class="content">
                                <div class="author">
                                    ...
                                    <img class="avatar border-gray" src="assets/img/faces/face-3.jpg" alt="...">
                                      ...
                                      <h4 class="title"><?php echo $_COOKIE['Astname']." ".$_COOKIE['Andname'];?><br>
                                         <small><?php echo $_COOKIE['Auser']?></small>
                                      </h4>
                                    </a>
                                    <p class="description text-center"> 
                                    <?php 
                                            $email  = $_COOKIE['Aemail'];
                                            $stmt = $mysqli->prepare("SELECT bio
                                                    FROM admins
                                                                    WHERE email = ? LIMIT 1");
