...
<head>
    ...
    <title> الصفحة الرئيسية - الموقع </title>
...
<div class="starter-template">
  <h2>مرحبا بك في موقع (إسم موقعك )</h2>
  <p class="lead">يسمح لك موقع (إسم الموقع) بالقيام بالعديد من الأمور .<br> أضف ماتريد من وصف للموقع وماإلى ذلك .</p>
    <button type="button" onclick="location.href = 'login.php';" class="btn btn-primary btn-lg" data-toggle="tooltip" data-placement="bottom" title="الدخول لحسابك">الدخول لحسابك <i class="fas fa-user-circle"></i></button>
    <button type="button" onclick="location.href = 'register.php';" class="btn btn-danger btn-lg" data-toggle="tooltip" data-placement="bottom" title="التسجيل بالموقع">التسجيل بالموقع <i class="fas fa-user-astronaut"></i></button>
</div>
<footer class="my-5 pt-5 text-muted text-center text-small">
        <p class="mt-3 mb-3 text-muted text-center"><a href="privacy.php">الخصوصية</a> - <a href="terms.php"> القوانين  </a>-   
                <a href="#Facebook" data-toggle="tooltip" data-placement="top" title="" data-original-title="صفحة الفيسبوك"><i class="fab fa-facebook-square"></i></a>
                <a href="#Twitter" data-toggle="tooltip" data-placement="top" title="" data-original-title="متابعة على تويتر"><i class="fab fa-twitter"></i></a> 
                <a href="#Insta" data-toggle="tooltip" data-placement="top" title="" data-original-title="متابعة في الإنستغرام"><i class="fab fa-instagram"></i></a>
                -  2018©
                </p>
        </footer>
</main><!-- /.container -->
